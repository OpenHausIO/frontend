      ...
      <div class="h-100" v-if="page">
        <div
          ...
          <div v-for="(item, i) in page.items" :key="i" class="grid-item text-center"
            ...
            style="border-left-color: blue; border-bottom-color: red; border-top-color: yellow; border-right-color:yellow">
            <div style="font-size: 12px;" class="d-block w-100 text-center">
              <h1> {{ item.title }}</h1>
              <h5>#{{ i }}&nbsp;</h5>
              <div>
